...
export const EditableArticleDetailsImgBlock = memo(({ block, onImgChange, onImgTitleChange }: IEditableArticleDetailsImgBlockProps) => {
	...
	return (
		<>
			...
			<Input value={block.title} onChange={onImgTitleChangeHandle} theme={InputTheme.INVERT} textInvert floatPlaceholder={t('Image title')} />
			<Input value={block.src} onChange={onImgChangeHandle} theme={InputTheme.INVERT} textInvert floatPlaceholder={t('Image')} />
		</>
	);
});
