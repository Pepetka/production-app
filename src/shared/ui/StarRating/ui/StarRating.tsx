			...
			<HStack data-testid="StarRating" className={className}>
				{starsArray.map((star) => (
					<Button
						...
						data-selected={
							selectedStar === star ? `StarRating.${selectedStar}` : undefined
						}
						...
						hover={false}
						onClick={
							selectedStar !== undefined ? undefined : onSelectStar(star)
						}
						theme={ButtonTheme.CLEAR}
						key={star}
						onMouseEnter={
							selectedStar !== undefined ? undefined : onMouseEnterHandle(star)
						}
						onMouseLeave={
							selectedStar !== undefined ? undefined : onMouseLeaveHandle
						}
					>
						<Icon
							size="size_l"
